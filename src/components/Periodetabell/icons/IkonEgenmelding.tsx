...
const IkonEgenmelding = ({
    color = "#b7b1a9",
    width = 16,
    height = 16
}: IconProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width} height={height} viewBox="0 0 24 24" enable-background="new 0 0 24 24" xmlSpace="preserve">
            <g fill={color}>
