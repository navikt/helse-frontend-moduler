...
export const PaginertTabell = () => {
    ...
    return (
        <>
            <Tabell beskrivelse="en paginert tabell" rader={tabellrader} headere={tabellheadere} {...rest} />
            <BottomContainer>
                <p>
                    Viser {paginering?.førsteSynligeElement} til {paginering?.sisteSynligeElement} av {tabellrader.length} oppgaver
                </p>
